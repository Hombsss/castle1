...
let TextureGrass = new THREE.TextureLoader().load( 'assets/textures/ocean.png' );
...
let bridge = new THREE.TextureLoader().load( 'assets/textures/bridge.png' );

let bridgeM = new THREE.MeshBasicMaterial( { map: bridge } );
...
let grassM = new THREE.MeshBasicMaterial( { map: grass1 } );


//LAND 
let plane = new THREE.PlaneBufferGeometry(1000, 1600, 2, 2);

let bridgeMain = new THREE.Mesh(geometryBo11, bridgeM);
let rightRo = new THREE.Mesh(geometryLa, roof2);
let leftRo = new THREE.Mesh(geometryLa, roof2);

let grassMoat = new THREE.Mesh(geometryTo1, grassM);
...
function animate() {
   ...
   //bridge
   bridgeMain.position.x=0;
   bridgeMain.position.y=10;
   bridgeMain.position.z=20;
   bridgeMain.rotation.y=-80;
  ...
  //moat
  grassMoat.position.x=0;
  grassMoat.position.y=10;
  grassMoat.position.z=-100;
  grassMoat.rotation.x=-1500;
  grassMoat.rotation.y=0;
